            ...
            <Container>
                <Wrapper>
                    <Box sx={{textAlign:"center"}}>
                        <Image src={logo} alt=""/>
                        <Typography fontWeight={"700"} color="primary" marginTop={"10px"} sx={{fontSize:{sm:"24px",xs:"18px"}}}>إنشاء حساب جديد</Typography>
                    </Box>
                    <Box marginTop={"50px"}>
                        <TextField id="outlined-basic" label="الإسم الكامل" variant="outlined" fullWidth sx={{marginBottom:"30px"}} required/>
                        ...
                        <ButtonWrapper>
                            <Typography variant='h6' sx={{fontWeight:"600", fontSize:"16px"}}>تسجيل</Typography>
                        </ButtonWrapper>
                    </Box>
                </Wrapper>
            </Container>
